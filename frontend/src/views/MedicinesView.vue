...
const isAdmin = sessionStorage.getItem('medicine-role') === 'ADMIN'
...
<template>
  <section class="page"><div class="page-heading"><div><p class="eyebrow">MEDICINES</p><h1>药品管理</h1><p>维护药品档案，执行入库、出库及库存盘点</p></div><button v-if="isAdmin" class="button primary" @click="openCreate">＋ 新增药品</button></div>
